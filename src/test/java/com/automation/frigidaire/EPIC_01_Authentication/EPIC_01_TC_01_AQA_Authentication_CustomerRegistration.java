...
public class EPIC_01_TC_01_AQA_Authentication_CustomerRegistration extends BaseTest {
    ...
    public void EPIC_01_Authentication_TC_01_S3_S4_S5_VerifyVerificationEmailReceivedAfterAccountCreation() {
        ...
        Assert.assertEquals(yopmailPage.getMailThanksForCreatingAccountMessage(), "Thanks for creating an account with Frigidaire. Please take a second to make sure we have your correct email address so that we can activate your account now. You can always change your password on your profile.", "Thank you for creating account body text is not present in the mail");
        ...
        Assert.assertEquals(yopmailPage.getNotIntendedRecipientMessage(), "If you are not the intended recipient of this email, please delete this message and contact us immediately. Thanks for your help.", "'If you are not intended recipient of this email' text is not present in the mail");
