...
public class EPIC_04_TC_01_PLP_Filters_AirCare extends BaseTest {
    ...
    public void  EPIC_04_PLP_TC_01_testExpandAndCollapseFilter() throws InterruptedException {
        ...
        PLPProductItemsPageActions_Frig.verifyProductItemPage("Window Mounted Air Conditioners", "Window Mounted Air Conditioners");
        PLPProductItemsPageActions_Frig.verifyFiltersInProductItems("Availability", 60, "Availability");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Features", "ENERGY STAR Certified");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "BTU", "5,000 BTU");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Noise Level on Low", "Quiet (42-47 dBA)");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Voltage Rating", "115 V");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Min Window Opening Width", "23\"");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Max Window Opening Width", "36\"");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Min Window Opening Height", "14\"");
        PLPProductItemsPageActions_Frig.verifyExpandAndCollapseFilter("frigidaire", "Price", "$0-$249");
    ...
    public void  EPIC_04_PLP_TC_01_testResetAll() throws InterruptedException {
        navigateToAirCare("frigidaire", "Air Care", "Window Mounted AC");
        PLPProductItemsPageActions_Frig.verifyProductItemPage("Window Mounted Air Conditioners", "Window Mounted Air Conditioners");
        PLPProductItemsPageActions_Frig.featureFilter("frigidaire", "BTU ", "5,000 BTU ");
        PLPProductItemsPageActions_Frig.verifySelectedFilters("5,000 BTU ");
    ...
    public void EPIC_04_PLP_TC_01_verifyPLPUpdatesForBTUFilter() throws InterruptedException {
        ...
        PLPProductItemsPageActions_Frig.verifyFiltersInProductItems("Availability", 60, "Availability");
        PLPProductItemsPageActions_Frig.featureFilter("frigidaire", "BTU ", " 5,000 BTU ");
        PLPProductItemsPageActions_Frig.openAllProductsAndValidate("Performance", "BTU (Cool)", "5000 BTU");
    ...
    public void EPIC_04_PLP_TC_01_verifyPLPUpdatesForVoltageRatingFilter() throws InterruptedException {
        ...
        PLPProductItemsPageActions_Frig.verifyProductItemPage("Window Mounted Air Conditioners", "Window Mounted Air Conditioners");
        PLPProductItemsPageActions_Frig.verifyFiltersInProductItems("Availability", 60, "Availability");
        PLPProductItemsPageActions_Frig.featureFilter("frigidaire", "Voltage Rating ", " 115 V ");
        PLPProductItemsPageActions_Frig.openAllProductsAndValidate("Electrical Specifications", "Voltage Rating", "115 V");
    ...
    public void EPIC_04_PLP_TC_01_verifyPLPUpdatesForMinWindowOpeningWidthFilter() throws InterruptedException {
        ...
        PLPProductItemsPageActions_Frig.verifyProductItemPage("Window Mounted Air Conditioners", "Window Mounted Air Conditioners");
        PLPProductItemsPageActions_Frig.verifyFiltersInProductItems("Availability", 60, "Availability");
        PLPProductItemsPageActions_Frig.featureFilter("frigidaire", "Min Window Opening Width ", " 23\" ");
        PLPProductItemsPageActions_Frig.openAllProductsAndValidate("Dimensions and Volume", "Window Width Minimum", "26 1/2\"");
    ...
    public void EPIC_04_PLP_TC_01_verifyPLPUpdatesForMaxWindowOpeningWidthFilter() throws InterruptedException {
        ...
        PLPProductItemsPageActions_Frig.verifyProductItemPage("Window Mounted Air Conditioners", "Window Mounted Air Conditioners");
        PLPProductItemsPageActions_Frig.verifyFiltersInProductItems("Availability", 60, "Availability");
        PLPProductItemsPageActions_Frig.featureFilter("frigidaire", "Max Window Opening Width ", " 36\" ");
        PLPProductItemsPageActions_Frig.openAllProductsAndValidate("Dimensions and Volume", "Window Width Maximum", "36\"");
   ...
   // @Test(groups = {"regression"}, description = "Verify Select yoour room size")
    public void EPIC_04_PLP_TC_01_verify_Select_Your_Room_Size_Filter() throws InterruptedException {
        ...
        PLPProductItemsPageActions_Frig.verifyProductItemPage("Window Mounted Air Conditioners", "Window Mounted Air Conditioners");
        PLPProductItemsPageActions_Frig.verifyFiltersInProductItems("Availability", 60, "Availability");
        PLPProductItemsPageActions_Frig.verifyAcRoomSize(" Small Room", "Performance", "Cool Area", "250", 100, 350);
//         loadMoreProducts(driver);
//         validateAirCareProductsForRoomSize( SpecsName ,  SpecsKey ,  SpecValue ,  lowerBound, upperBound);
        PLPProductItemsPageActions_Frig.validateAirCareProductsForRoomSize("Performance", "Cool Area", "250", 100,350);
