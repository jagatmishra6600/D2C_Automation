...
public class EPIC_09_TC_02_AQA_CheckoutLogin_Login_Frig extends BaseTest {
	...
	public void EPIC_09_CheckoutLogin_TC_02_VerifyCheckoutLoginSectionAndUserLoginSuccess() {
		...
		assertTrue(shippingAddressPage.isLoginSectionDisplayed(),"Log In Section is not present in the Checkout Shipping Address Page");
		assertTrue(shippingAddressPage.isLoginButtonDisplayed(),"Log In Button is not displayed in the Checkout Shipping Address Page");
