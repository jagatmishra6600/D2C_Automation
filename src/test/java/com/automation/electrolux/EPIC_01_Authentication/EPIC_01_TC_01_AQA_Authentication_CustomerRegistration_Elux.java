...
import com.automation.electrolux.pages.CreateAccountPageActionsElux;
...
public class EPIC_01_TC_01_AQA_Authentication_CustomerRegistration_Elux extends BaseTest {
 	HomePageActionsElux homePage = new HomePageActionsElux();
 	LoginPageActionsElux loginPage = new LoginPageActionsElux();
 	CreateAccountPageActionsElux createAccountPage = new CreateAccountPageActionsElux();
