...
public class ReviewLocatorsElux {
    ...
    public final By productRating = By.xpath("//div[contains(@class,'bv_avgRating_component_container')]");
    public final By totalReviews = By.xpath("//div[@class='bv_numReviews_component_container']//div[@class='bv_numReviews_text']");
    public final By ratingSnapshot = By.cssSelector(".bv_rating_content1");
    public final By banner = By.xpath("//cx-page-slot[contains(@class,'eluxStaticLuxPdpFeature')]");
    ...
    public final By paginationInfo = By.cssSelector("div.bv-rnr__sc-11r39gb-2.kbTMsI");
