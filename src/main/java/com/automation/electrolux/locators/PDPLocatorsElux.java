...
public class PDPLocatorsElux {
    ...
    public final By pdpHeight = By.xpath("//div[normalize-space(text())='Height']");
    public final By pdpWidth = By.xpath("//div[normalize-space(text())='Width']");
    public final By pdpDepth = By.xpath("//div[normalize-space(text())='Depth']");
    public final By quickSpecificationBtnOnPDP = By.xpath("//span[text()='Specs']");
    public final By overViewAndFeatures = By.xpath("//span[text()='Overview'");
    ...
    public final By selectedProductName = By.xpath("//p[contains(@class, 'prod_name Product-title')]");
