...
public class CheckoutForgotPasswordPageActionsElux {

	 public CheckoutForgotPasswordPageActionsElux navigateToForgotPasswordPage() {
	 ...
	 public CheckoutForgotPasswordPageActionsElux enterEmailAddress(String emailAddress) {
	 ...
	 public CheckoutForgotPasswordPageActionsElux clickResetPasswordButton() {
		 WebElementUtil.clickElement(ForgotPasswordLocatorsElux.resetPasswordButton);
		 return this;
	 }
	 
	 public CheckoutForgotPasswordPageActionsElux resetPassword(String emailAddress) {
	 ...
	 public CheckoutForgotPasswordPageActionsElux verifyForgotPasswordPage() {
