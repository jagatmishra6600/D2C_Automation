...
public class DeliveryAndServicePageActionElux {
    DandSLocatorElux dns_Locator = new DandSLocatorElux();
    ...
    public boolean isProductTitleMatchingWithHomePage() {
        ...
        String expectedTitle = ElectroluxHomePageActions.getProvidedProductTitle().trim();
    ...
    public DeliveryAndServicePageActionElux clickAdditionalDetailsLink() {
    ...
    public DeliveryAndServicePageActionElux clickCloseButtonAdditionalDetails() {
