...
import com.automation.familystoreus.locators.CheckoutLocatorsFsus;
...
public class CheckoutPageActionsFsus {
    private final CheckoutLocatorsFsus locators = new CheckoutLocatorsFsus();
