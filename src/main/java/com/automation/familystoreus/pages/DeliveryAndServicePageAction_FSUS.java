...
import com.automation.familystoreus.locators.DeliveryAndServicesPageLocator_FSUS;
import com.automation.utils.WaitUtils;
import com.automation.utils.WebElementUtil;
import org.openqa.selenium.By;
import org.testng.Assert;

public class DeliveryAndServicePageAction_FSUS {

    DeliveryAndServicesPageLocator_FSUS dns_Locator = new DeliveryAndServicesPageLocator_FSUS();
    ...
    public boolean isProductTitleMatchingWithHomePage() {
        ...
        String expectedTitle = HomePageActionsFsus.getProvidedProductTitle().trim();
    ...
    public boolean isProductPriceMatchingWithHomePage() {
        ...
        String expectedPrice = HomePageActionsFsus.getProvidedProductPrice().trim();
    ...
    public DeliveryAndServicePageAction_FSUS clickAdditionalDetailsLink() {
    ...
    public DeliveryAndServicePageAction_FSUS clickCloseButtonAdditionalDetails() {
    ...
    public CartPageAction_FSUS clickSaveAndViewCartButton() {
