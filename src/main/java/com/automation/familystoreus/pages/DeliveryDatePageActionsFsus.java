...
import com.automation.familystoreus.locators.DeliveryDatesLocatorsFsus;
...
public class DeliveryDatePageActionsFsus {
    DeliveryDatesLocatorsFsus locators = new DeliveryDatesLocatorsFsus();
