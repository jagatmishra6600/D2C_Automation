...
public class FedexServiceLocatorsFsus {
    ...
    public By deliveryPrice = By.xpath("//div[normalize-space(.)='Delivery only (No Install)']/ancestor::div[@class='d-flex']//div[@id='deliveryInstalltn']//div[@class='priceFree']//span");
