...
public class ReviewLocatorsFsus {
    ...
    public final By productRating = By.xpath(
            "//div[@class='pdp_info_wrapper']//div[@itemprop='ratingValue'] | //div[contains(@class,'bv_avgRating_component_container')]");
    public final By totalReviews = By.xpath(
            "//div[@class='pdp_info_wrapper']//div[@class='bv_numReviews_text'] | //div[@class='bv_numReviews_component_container']//div[@class='bv_numReviews_text']");
    public final By ratingSnapshot = By.cssSelector(".bv_rating_content1");
    public final By banner = By.xpath(
            "//cx-page-slot[contains(@class,'frigStaticPdpFeature')] | //cx-page-slot[contains(@class,'eluxStaticLuxPdpFeature')]");
    public final By star4 = By.cssSelector("div.bv-reviews-product-rating-star:nth-of-type(4)");
    public final By messagePopup = By
            .cssSelector("div.bv-rnr__sc-2kyvjj-5.jJMAoq > span, div.bv-rnr__sc-2kyvjj-5.fqNDpx > span");
    ...
    public final By outerHostSelector = By
            .cssSelector("div.bv-pdp-review.ng-star-inserted, app-elux-pdp-reviews, .bv-pdp-review.ng-star-inserted");
    public final By ratingFilter = By.cssSelector("div.bv-rnr__sc-1wzl89g-0.knIejS");
