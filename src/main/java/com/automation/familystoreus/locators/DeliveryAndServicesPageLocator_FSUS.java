...
public class DeliveryAndServicesPageLocator_FSUS {
    ...
    public final By deliveryOnlyPrice =  By.xpath("//div[normalize-space(text())='Delivery only (No Install)']/../following-sibling::div/div/span");
    ...
    public final By partPrice = By.xpath("//input[@id='912001026']//..//following-sibling::div//span");
    public final By professionalInstallationPrice =  By.xpath("//div[normalize-space(text())='Professional installation']/../following-sibling::div/div/span");
    ...
    public final By deliveryAndAppliancesInstallText =  By.xpath("//ngb-modal-window//span[text()='Included with service:']");
    public final By closePopUpButton = By.xpath("//ngb-modal-window//button[@aria-label='Close']");
    public final By addOnServiceText = By.xpath("//p[text()='Add-on Service']");
    ...
    public final By availableProtectionPlanText = By.xpath("//h3[normalize-space(text())='Protection plan']");
