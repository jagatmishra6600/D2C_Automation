...
public class YopmailPageActionsFrig {
	...
	public YopmailPageActionsFrig navigateToYopmailPage() {
		WebElementUtil.navigateTo("https://yopmail.com/");
		return this;
	}
	
	public YopmailPageActionsFrig enterEmailAddress(String emailAddress) throws InterruptedException {
		WaitUtils.sleep(2000);
		WebElementUtil.sendKeys(emailAddressField, emailAddress);
		return this;
	}
	
	public YopmailPageActionsFrig clickCheckInboxButton() {
	...
	public YopmailPageActionsFrig login(String emailAddress) throws InterruptedException {
		return navigateToYopmailPage()
					.enterEmailAddress(emailAddress)
					.clickCheckInboxButton();
	}
	
	public YopmailPageActionsFrig clickInboxRefresh() {
		WebElementUtil.clickElement(inboxRefreshButton);	
		return this;
	}
	
	public YopmailPageActionsFrig clickFirstMailInInbox() {
	...
	public YopmailPageActionsFrig openFirstMailInInbox(String emailAddress) throws InterruptedException {
