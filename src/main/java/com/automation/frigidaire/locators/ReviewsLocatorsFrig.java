...
public class ReviewsLocatorsFrig {
    ...
    public final By totalReviews = By.xpath("//div[@class='pdp_info_wrapper']//div[@class='bv_numReviews_text']");
    public final By ratingSnapshot = By.cssSelector(".bv_rating_content1");
    public final By totalRatingsRS = By.cssSelector("div.bv-rnr__sc-157rd1w-1.kMbsEl");
    public final By overallRatingRS = By.cssSelector("div.bv-rnr__sc-157rd1w-2.krTpQg");
    public final By banner = By.xpath("//cx-page-slot[contains(@class,'frigStaticPdpFeature')]");
    public final By star4 = By.cssSelector("div.bv-reviews-product-rating-star:nth-of-type(4)");
    public final By ratingPopup = By.cssSelector("div.ips__sc-152gkq8-1.isjTu");
    ...
    public final By paginationInfo = By.cssSelector("div.bv-rnr__sc-11r39gb-2.cTgetK");
    ...
    public final By outerHostPopup = By.cssSelector("div[data-bv-show='inpage_submission'][data-bv-ready='true']");
